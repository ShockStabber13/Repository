...
async function getE2bApiKey(): Promise<string> {
  ...
  const key = (
    await question("Enter your E2B API Key (leave blank for local-only): ")
  ).trim();
...
# =============================================================================
# Featherless is the model provider for this local fork.
# Save the API key and selected model from /featherless-settings after startup.
HACKERAI_AI_PROVIDER=featherless
FEATHERLESS_API_KEY=
FEATHERLESS_MODEL_ID=
FEATHERLESS_BASE_URL=https://api.featherless.ai/v1
NEXT_PUBLIC_HACKERAI_MAX_CONTEXT_TOKENS=32768

# OpenAI remains required by upstream HackerAI for content moderation.
